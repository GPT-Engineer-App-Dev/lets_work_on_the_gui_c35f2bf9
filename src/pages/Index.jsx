    ...
    <Container maxW="container.xl" p={5}>
      <VStack spacing={5}>
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          {/* Main Chat Interface */}
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="1px" borderRadius="lg" shadow="md">
            <VStack spacing={4}>
              <Box w="full" h="500px" p={3} overflowY="auto" borderWidth="1px" borderRadius="lg" bg="gray.50" shadow="sm">
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={5}>
            <Box w="full" h="250px" borderWidth="1px" borderRadius="lg" overflow="hidden" shadow="sm">
          ...
          <Box w="full" p={5} borderWidth="1px" borderRadius="lg" shadow="md">
            <VStack spacing={4}>
